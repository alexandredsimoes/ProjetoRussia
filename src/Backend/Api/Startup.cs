...
namespace CRUD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TimeContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DBTIME")));

            services.AddMvc();

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info { Title = "Projeto Rússia - API", Version = "v1" });
            });
